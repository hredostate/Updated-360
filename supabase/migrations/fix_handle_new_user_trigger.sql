-- Migration: Fix handle_new_user trigger to properly populate student_record_id
-- This updates the trigger function to link student_profiles with students records
...
-- The trigger already exists from the original schema, no need to recreate it
