...
const TourModal: React.FC<TourModalProps> = ({ isOpen, onClose, tourContent }) => {
  const [currentStep, setCurrentStep] = useState(0);

  if (!isOpen || tourContent.length === 0) return null;
        ...
        <div className="flex justify-between items-center">
          {currentStep > 0 ? (
            ...
            >
             ...
             <button onClick={onClose} className="px-4 py-2 text-sm font-semibold">Skip</button>
          )}
