...
const SurveyResultsView: React.FC<SurveyResultsViewProps> = ({ survey, onBack, addToast }) => {
    ...
    const handleAnalyzeResults = async () => {
        ...
        try {
            ...
            Analyze the provided survey results and generate a summary.
            Your analysis should include:
            1. An overall summary of participation.
            2. Identification of key trends in the responses.
            3. Key themes or insights from any open-ended (short answer) questions.
            4. Actionable recommendations for the school based on this feedback.
