...
const UserManagement: React.FC<UserManagementProps> = ({ users = [], roles, campuses = [], onInviteUser, onDeactivateUser, onUpdateUserCampus }) => {
                            ...
                            {paginatedUsers.map(user => (
                                <tr key={user.id} className="border-b border-slate-200/60 dark:border-slate-700/60 hover:bg-slate-500/10">
                                    ...
                                    <td className="px-6 py-4 text-right whitespace-nowrap">
                                        <button onClick={() => onDeactivateUser(user.id, false)} className="font-medium text-red-600 dark:text-red-400 hover:underline">
                                            Deactivate
                                        </button>
                                    </td>
                                </tr>
