...
export const ALL_WIDGETS: WidgetDefinition[] = [
  ...
  { id: 'at-risk-students', title: 'At-Risk Students', description: 'Students flagged by AI as needing attention.', requiredPermission: 'manage-students' },
  ...
  { id: 'student-records', title: 'Student Records', description: 'Quickly search for a student.', requiredPermission: 'manage-students' },
